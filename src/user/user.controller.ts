import { Controller, Get, Post, Body, HttpException, HttpStatus, Inject, Param } from '@nestjs/common';
...
export class UserController {
    ...
    @Post()
    createUser(@Body() userData: { name: string; lastname: string; email: string; phone?: string }): Observable<any> {
